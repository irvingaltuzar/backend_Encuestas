...
class CreateSegAuditoriaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('seg_auditoria', function (Blueprint $table) {
            $table->integer('auditoriaId')->primary();
            ...
            $table->foreign('subsecId', 'fk_SEG_AUDITORIA_SEG_SUBSECCION1')->references('subsecId')->on('seg_subseccion')->onDelete('restrict')->onUpdate('restrict');
        });
    }
