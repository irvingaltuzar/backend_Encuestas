...
class CreateDistributionListTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('distribution_list', function (Blueprint $table) {
            ...
            $table->foreign('cat_distribution_list_type_id', 'fk_distribution_list_cat_distribution_list_type1')->references('id')->on('cat_distribution_list_type')->onDelete('restrict')->onUpdate('restrict');
        });
    }
